export default function Testimonials() {
  const reviews = [
    ...
    { name: "Ridhi", role: "Lost 30 lbs in 4 months", text: "I had tried every diet and gym routine before but nothing worked long-term. Kuldeep's approach was different — sustainable nutrition and workouts I actually enjoyed. Down 30 lbs and keeping it off!", avatar: "R" },
